...
public class MultiWindowModeActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (BuildConfig.DEBUG) {
            LogUtils.debug("MultiWindowModeActivity.onCreate() ## ");
        }
    ...
    protected void onRestart() {
        super.onRestart();
        if (BuildConfig.DEBUG) {
            LogUtils.debug("MultiWindowModeActivity.onRestart() ## ");
        }
    }
    ...
    protected void onStart() {
        super.onStart();
        if (BuildConfig.DEBUG) {
            LogUtils.debug("MultiWindowModeActivity.onStart() ## ");
        }
    }
    ...
    protected void onResume() {
        super.onResume();
        if (BuildConfig.DEBUG) {
            LogUtils.debug("MultiWindowModeActivity.onResume() ## ");
        }
    }
    ...
    protected void onPause() {
        super.onPause();
        if (BuildConfig.DEBUG) {
            LogUtils.debug("MultiWindowModeActivity.onPause() ## ");
        }
    }
    ...
    protected void onStop() {
        super.onStop();
        if (BuildConfig.DEBUG) {
            LogUtils.debug("MultiWindowModeActivity.onStop() ## ");
        }
    }
    ...
    protected void onDestroy() {
        super.onDestroy();
        if (BuildConfig.DEBUG) {
            LogUtils.debug("MultiWindowModeActivity.onDestroy() ## ");
        }
    }
}
